...
function is_logged_in() {
    return isset($_SESSION['the_seccret']);
}

function login($password) {
    $valid_password_hash = '$2y$10$RNCNifFZ1gShBsRGCdSbGeosoACDtcK8F7oysW.ic3zkKfIKjaTVq'; // Contoh hash bcrypt
    if (password_verify($password, $valid_password_hash)) {
        $_SESSION['the_seccret'] = 'user';
        return true;
    } else {
        return false;
    }
...
if (is_logged_in()) {
    ...
    $image_path = 'https://asset-2.tstatic.net/kupang/foto/bank/images/bra-ilustrasi_20180912_162433.jpg';
    readfile($image_path);
}
